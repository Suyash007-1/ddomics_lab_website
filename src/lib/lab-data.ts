...
export const people: Person[] = [
  {
    ...
    group: "pi",
    link: "/dhiraj-dhotre",
    photo: "/images/people/dhiraj-dhotre.jpg",
  },
  { slug: "niraj-rane", name: "Dr. Niraj Rane", role: "Project Scientist", group: "scientist" },
  { slug: "mitali-inamdar", name: "Mitali Inamdar", role: "Ph.D. Student", group: "student" },
  {
    ...
    role: "Ph.D. Student",
    group: "student",
    photo: "/images/people/suyash-jadhav.jpg",
  },
  { slug: "puja-ghosh", name: "Puja Ghosh", role: "Ph.D. Student", group: "student" },
  { slug: "harshada-pardeshi", name: "Harshada Pardeshi", role: "Ph.D. Student", group: "student" },
  ...
  { slug: "tanaya-ghanvatkar", name: "Tanaya Ghanvatkar", role: "Project Staff", group: "staff" },
];

export const alumni = [
  { name: "Dr. Dattatray S. Mongad", role: "Ph.D. Student" },
  { name: "Dr. Kunal Dixit", role: "Ph.D. Student" },
];
